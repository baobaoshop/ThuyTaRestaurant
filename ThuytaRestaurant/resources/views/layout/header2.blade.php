<div class="header">
    <a href="{{ route('home.index') }}" class="header_left">
        ...
        <div class="header_name header_name2">
    ...
    <div class="header_right">
        <div class="header_main">
            <a href="{{ route('menu.index') }}" class="header_main_item header_main_item2 {{ Request::is('menu*') ? 'header_main_item--active' : '' }}">Thực đơn</a>
            <div class="header_main_item header_main_item2 header_main_item--dropdown {{ Request::is('banquet*') ? 'header_main_item--active' : '' }}">
            ...
            <a href="{{ route('conference.index') }}" class="header_main_item header_main_item2 {{ Request::is('conference*') ? 'header_main_item--active' : '' }}">Phòng hội nghị</a>
            <a href="{{ route('promotion.index') }}" class="header_main_item header_main_item2 {{ Request::is('promotion*') ? 'header_main_item--active' : '' }}">Khuyến mãi tiệc cưới</a>
        </div>
